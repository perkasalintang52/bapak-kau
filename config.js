...
global.linkGC = ['instagram.com/joceylintangg', 'tiktok.com/@joceylintangg', '-'] // ganti jadi group lu
...
if (stickerpack.spackname == '') {
  var sticker_name = 'KAMAGAPO BOT'
  var sticker_author = 'by KAMAGAPO BOT'
} else {
...
global.watermark = '©KAMAGAPO BOT' //change the watermark (beberapa harus manual)
